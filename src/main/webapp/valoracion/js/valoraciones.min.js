(function($){
    var Valoraciones=function(elemento,opciones){
        var clase=this;var $contenedor=$(elemento);
        var atributo='star';var filtro="["+atributo+"='valor']";
